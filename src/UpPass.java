/*JAVA FILE********************************************************************
 * FILENAME :	UpPassCl.java
 *
 * DESCRIPTION :
 **	Class that, in a recursive and multithread manner, calculates the binary..
 * ..tree so that the Prefix Sum can be calculated in parallel.
 *
 * CLASS INHERITANCE :
 ...
 ** 1) int result -- For each thread, hold the resulting calculation.
 *
 * PUBLIC INSTANCE METHODS :
 ** 1) void run() -- Overrides the run() method of the Thread class.
