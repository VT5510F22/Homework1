...
public class writeOutFileBetter extends RecurrBetter {
     ...
     */
    public writeOutFileBetter () {
        outFileName = "out.txt";
        fileBuffSizeInt = 1000;
    }

    public writeOutFileBetter (int fileBuffer, int addNum) {
        this.fileBuffSizeInt = fileBuffer;
        outFileName = "out.txt";
    }

    public writeOutFileBetter (String outFileName, int addNum) {
        this.outFileName = outFileName;
        fileBuffSizeInt = 1000;
    }

    public writeOutFileBetter (String outFileName,int fileBuffer, int addNum) {
        this.fileBuffSizeInt = fileBuffer;
        this.outFileName = outFileName;
    }
